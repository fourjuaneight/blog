...
- **[beyerdynamic DT 990 Pro](https://north-america.beyerdynamic.com/dt-990-pro.html)** - These are overkill for essentially Zoom and podcasts. But TOOL does sounds lovely in loseless.
...
- **iPhone 12 Mini** - This is the perfect size. Fight me.
...
- **[VS Code](https://code.visualstudio.com)** - Honestly, I've tried all the editors at this point. This is by far the most decent one. It solid enough, way too customizable, and integrates perfectly with all my tooling.
...
There's obviosuly several more hardware and software I use. But these are the main things I cannot live without on a daily basis.
