...
const getBookmarksWithOffset = async (
  ...
  const endpoint = `https://api.airtable.com/v0/${env.AIRTABLE_BOOKMARKS_ID}/${table}?maxRecords=100&sort%5B0%5D%5Bfield%5D=${sorttitle}&sort%5B0%5D%5Bdirection%5D=asc&sort%5B1%5D%5Bfield%5D=${sortCreator}&sort%5B1%5D%5Bdirection%5D=asc`;
